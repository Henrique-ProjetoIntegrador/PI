...
<div class="row text-center">
    ...
    <div class="imagem-clientes col-lg-4 offset-2">
        <figure class="figure">
            <a href="../cliente/clientes.php"><img src="../../icones/Clientes.webp" class="figure-img img-fluid rounded"
    ...
    <div class="imagem-veiculos col-lg-4 ">
        <figure class="figure">
            <a href="../veiculo/veiculo.php"><img src="../../icones/veiculo.png" class="figure-img img-fluid rounded" alt="Ícone veículo" width=250 height=250></a>
